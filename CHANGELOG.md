...
## 0.5.7 (2022-05-30)
- Restored compability with systems besides LANCER - Module should now function as intended for all previous systems again.
...
- Added support for LANCER system
  ...
  - Added default LANCER settings
  - Added appropriate settings description for English and German. French, Spanish, and Japanese still pending.
